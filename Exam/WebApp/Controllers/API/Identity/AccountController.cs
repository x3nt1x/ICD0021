...
public class AccountController : ControllerBase
{
    ...
    [HttpGet]
    [ProducesResponseType(typeof(IEnumerable<App.Public.DTO.Identity.AppUser>), StatusCodes.Status200OK)]
    public async Task<ActionResult<IEnumerable<App.Public.DTO.Identity.AppUser>>> GetUsers()
    {
